...
if [ -z "$1" ]; then
    ...
    echo -e "${green}║                                                                                        ║${neutral}"
    echo -e "${green}║        ______   __                                          __                  ______║${neutral}" 
    echo -e "${green}║       /      \ /  |                                        /  |                /      \║${neutral}"
    echo -e "${green}║      /$$$$$$  |$$ |  ______    ______    _______   _______ $$ |____    ______  /$$$$$$║${neutral}"
    echo -e "${green}║      $$ |__$$ |$$ | /      \  /      \  /       | /       |$$      \  /      \ $$ \__$$║${neutral}"
    echo -e "${green}║      $$    $$ |$$ |/$$$$$$  |/$$$$$$  |/$$$$$$$/ /$$$$$$$/ $$$$$$$  | $$$$$$  |$$    $$║${neutral}"
    echo -e "${green}║      $$$$$$$$ |$$ |$$ |  $$/ $$    $$ |$$      \ $$ |      $$ |  $$ | /    $$ | $$$$$$║${neutral}"
    echo -e "${green}║      $$ |  $$ |$$ |$$ |      $$$$$$$$/  $$$$$$  |$$ \_____ $$ |  $$ |/$$$$$$$ |/  \__$$║${neutral}"
    echo -e "${green}║      $$ |  $$ |$$ |$$ |      $$       |/     $$/ $$       |$$ |  $$ |$$    $$ |$$    $$║${neutral}"
    echo -e "${green}║      $$/   $$/ $$/ $$/        $$$$$$$/ $$$$$$$/   $$$$$$$/ $$/   $$/  $$$$$$$/ $$$$$$$/║${neutral}"
    echo -e "${green}║                                                                                        ║${neutral}"
    echo -e "${green}╚════════════════════════════════════════════════════════════════════════════════════════╝${neutral}"
...
shadowsocks_url="https://raw.githubusercontent.com/alrescha79-cmd/sc-vpn/main/VMess-VLESS-Trojan+Websocket+gRPC/shadowsocks/config.json"
